...
--
-- Current Database: `mantenimiento`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mantenimiento` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `mantenimientos` (
  ...
  `hora1` datetime NOT NULL,
  `hora2` datetime NOT NULL,
  `maquina` int(11) NOT NULL,
  `causas` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contramedidas` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_resets_table',1),(3,'2019_08_19_000000_create_failed_jobs_table',1),(4,'2020_09_22_142156_mantenimientos',1);
...
CREATE TABLE `password_resets` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  KEY `password_resets_usuario_index` (`usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `usuaro` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_usuaro_unique` (`usuaro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
